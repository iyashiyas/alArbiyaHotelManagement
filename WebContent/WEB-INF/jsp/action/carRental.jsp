   ...
   <jsp:include page="../header/header.jsp"></jsp:include>
	...
	<div id="page-wrapper" class="gray-bg">
	  <div class="row wrapper border-bottom white-bg page-heading">
		<div class="col-lg-9">
			...
			<ol class="breadcrumb">
				<li><a
					href="${pageContext.request.contextPath}/">Rental Service</a></li>
				<li class="active"><strong>Rental</strong></li>
			</ol>
		</div>
		...
		<div class="ibox float-e-margins">
			...
			<div class="ibox-content">
				<form class="form-horizontal" action="" method="post">
					<p>Add Rental items Here</p>

					<div class="form-group">
						<label class="col-sm-2 control-label">Categories</label>

						<div class="col-sm-10">
							<select class="form-control m-b" name="carrental_Item_Category">
								<option>Bus</option>
								<option>Car</option>
							    </select>
						</div>
						...
						<div class="col-sm-10">
							<input type="text" placeholder="Item Name" name="carrental_Item_Name"
								class="form-control">
						</div>
					</div>
                    ...
                    <div class="entry input-group ">	
                      <select class="form-control m-b" id="language_dropdown"><option>Arabic</option><option>English</option></select> 
                        <input class="form-control"  type="text" name="other_language_rental" placeholder="Enter Name" />
					...
					<div class="form-group">
						<label class="col-sm-2 control-label">Price</label>
                           <div class="col-sm-10">
							<input type="text" placeholder="Item Name" name="rental_price"
								class="form-control">
						</div>
					</div>
    ...
    <span class="fileinput-filename"></span>
		...
		<div class="modal-dialog">
			<div class="modal-content">
			   <form class="form-horizontal" action="" method="post">
				<div class="modal-header">Edit carRental Services</div>
