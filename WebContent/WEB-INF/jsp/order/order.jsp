											...
											<c:forEach items="${orders}" var="orders">
												<tr class="gradeX">
													...
													<td class="center"><button type="button"
															data-toggle="modal" data-target="#orderconfirm"
															class="btn btn-default">Accept Request</button></td>

													<td class="center"><button type="button"
															data-toggle="modal" data-target="#orderconfirm"
															class="btn btn-default">Request for delivery</button></td>
													<td class="center"><button type="button"
															data-toggle="modal" data-target="#orderconfirm"
															class="btn btn-default">Delivered</button></td>
