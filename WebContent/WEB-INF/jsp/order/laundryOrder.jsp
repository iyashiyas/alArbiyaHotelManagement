						...
						<div class="ibox float-e-margins">
							<div class="ibox-title">
								<h3 class="text-center ">
									<label class="label label-primary"> Laundry Screen </label>
								</h3>
								<form
													...
													<td class="center"><sec:authorize
															...
															<c:choose>
																<c:when test="${orders.acceptTime == null}">
																	<a
																		href="${pageContext.request.contextPath}/order/laundryacceptOrder?id=${orders.id}&roomId=${orders.room.id}&serviceItemName=${orders.hotelServicesItem.serviceItemName}"
															...
															<c:choose>
																<c:when test="${orders.readyForDeliveryTime == null}">
																	...
																	<a href="#" id="readyForDeliverys" data-toggle="modal"
																		...
																		data-href="${pageContext.request.contextPath}/order/laundryreadyForDelivery?id=${orders.id}&roomName=${orders.room.roomCode}&roomId=${orders.room.id}"
...
{ 
  ...
  setTimeout(function(){newWin.close();},10);
	...
	<script src="<c:url value="/resources/js/order/laundryOrder.js" />"></script>
