...
<body>
 <form:form action="${pageContext.request.contextPath}/reservation/checkIn" method="post">
	<div class="col-xs-10 form-group">
		<label>Booking Number</label>
		<input class="form-control" name="bookingrefernceId"  placeholder="Bookin Number" type="text"> 
	</div> 
