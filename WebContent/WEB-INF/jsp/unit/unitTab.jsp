...
<body> 
          <div class="col-lg-3">
			...
			<div class="ibox-title">
				<h5><spring:message code="label.Categories" /> <sec:authorize access="hasAnyRole('ROLE_UNIT_NEWCATEGORY','ROLE_ADMIN')"> -  <a href="#addUnitCategory-Modal" data-toggle="modal" ><spring:message code="label.NewCategory" /></a></sec:authorize></h5>
			 </div> 
