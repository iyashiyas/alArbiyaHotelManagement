																			...
																			.append(
																					'<tr><td>'
																							...
																							+ (Orders.status == "READYFORDELIVERY" ? '<a class="btn btn-primary" href="#" id="confirmDeliveryRequest" data-toggle="modal" data-target="#confirmReadForDelivery" data-href="deliveryBoyAccept?orderId='
																									+ Orders.orderId
																									+ '">Accept Request</a>'
																									: (Orders.status == "ACCEPTREQUEST" ? '<a class="btn btn-danger" href="#" id="deliverdAccept" data-toggle="modal" data-target="#confirmDelivered" data-target="#confirmReadForDelivery" data-href="deliverdAcccept?id='
																											+ Orders.orderId
																											+ '&roomId='
																											+ Orders.roomId
																											+ '">Accept Delivery</a>'
